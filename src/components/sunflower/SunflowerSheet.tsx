...
export function SunflowerSheet({
  ...
  const maxStreak = streakData?.max_streak || currentStreak;
  const waterTokens = streakData?.water_tokens ?? 1;
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto px-5 py-4 space-y-5 scrollbar-none">
              ...
              <div className="py-2 text-center space-y-3">
                <SunflowerStage streak={currentStreak} size="md" animated />
                ...
                <div>
                  ...
                  <p className="text-xs text-[#81727B] font-medium mt-1">
                    Hai đứa đã cùng chăm bông hoa này suốt {currentStreak} ngày 💛
                  </p>
                </div>
              </div>
